...
function generatePdf(data, text, colorText, colorBackground) {
...

        {
          ...
          layout: {
            hLineWidth: function (i, node) {
              ...
              return i === node.table.body.length + node.table.headerRows
                ? 1
                : 0; // Adiciona uma linha abaixo do último corpo
            },
